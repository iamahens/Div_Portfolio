          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {learningPoints.map((point, index) => (
              <div key={index} className="relative group">
                ...
                <div className="relative z-10 bg-gray-800 rounded-xl p-6 h-full border border-gray-700 group-hover:border-cyan-500 transition-colors duration-300"> {/* Changed to cyan-500 border on hover */}
